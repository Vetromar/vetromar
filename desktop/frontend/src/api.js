...
export const api = {
  ...
  meetingRecord: (title = "") => jsonPost("/api/meetings/record", { title }),
  ...
  meetingSettingsGet: () => request("/api/settings/meetings"),
  meetingSettingsSave: (body) => jsonPost("/api/settings/meetings", body),
  transcriptionGet: () => request("/api/settings/transcription"),
  transcriptionSave: (mode) => jsonPost("/api/settings/transcription", { mode }),
